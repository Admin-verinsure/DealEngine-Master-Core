...
{
    public class TripleASLUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public TripleASLUWModule()
        {
            Name = "TripleA_SL";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            ClientAgreementTerm termsl2millimitoption = GetAgreementTerm(underwritingUser, agreement, "SL", TermLimit2mil, TermExcess);
            termsl2millimitoption.TermLimit = TermLimit2mil;
            termsl2millimitoption.Premium = TermPremium2mil;
            termsl2millimitoption.BasePremium = TermPremium2mil;
            ...
            if (agreement.ClientInformationSheet.IsChange && agreement.ClientInformationSheet.PreviousInformationSheet != null)
            {
                ...
                foreach (var term in PreviousAgreement.ClientAgreementTerms)
                {
                    if (term.Bound)
                    {
                        ...
                        termsl2millimitoption.PremiumDiffer = (TermPremium2mil - PreviousBoundPremium) * coverperiodindaysforchange / agreementperiodindays;
                        termsl2millimitoption.PremiumPre = PreviousBoundPremium;
                        if (termsl2millimitoption.PremiumDiffer < 0)
                        {
                            termsl2millimitoption.PremiumDiffer = 0;
                        }
                    }
            ...
            string auditLogDetail = "TripleA SL UW created/modified";
