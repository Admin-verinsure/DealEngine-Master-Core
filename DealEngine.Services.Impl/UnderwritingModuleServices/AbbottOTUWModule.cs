...
{
    public class AbbottOTUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public AbbottOTUWModule()
        {
            Name = "Abbott_OT";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            int TermExcess250k = 0;

            TermBrokerage250k = TermPremium250k * agreement.Brokerage / 100;

            ClientAgreementTerm termot250klimitoption = GetAgreementTerm(underwritingUser, agreement, "OT", TermLimit250k, TermExcess250k);
            termot250klimitoption.TermLimit = TermLimit250k;
            termot250klimitoption.Premium = TermPremium250k;
            termot250klimitoption.BasePremium = TermPremium250k;
            termot250klimitoption.Excess = TermExcess250k;
            termot250klimitoption.BrokerageRate = agreement.Brokerage;
            termot250klimitoption.Brokerage = TermBrokerage250k;
            termot250klimitoption.DateDeleted = null;
            termot250klimitoption.DeletedBy = null;

            //Change policy premium calculation
            if (agreement.ClientInformationSheet.IsChange && agreement.ClientInformationSheet.PreviousInformationSheet != null)
            {
                termot250klimitoption.Bound = true;
            }
            ...
            string auditLogDetail = "Abbott OT UW created/modified";
