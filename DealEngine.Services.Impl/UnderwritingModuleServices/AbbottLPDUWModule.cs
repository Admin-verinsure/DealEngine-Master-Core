...
{
    public class AbbottLPDUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public AbbottLPDUWModule()
        {
            Name = "Abbott_LPD";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            {
                foreach (ClientAgreementTerm plterm in agreement.ClientAgreementTerms.Where(ct => ct.SubTermType == "LPD" && ct.DateDeleted == null))
                {
            ...
            if (agreement.ClientInformationSheet.PreRenewOrRefDatas.Count() > 0)
            {
                foreach (var preRenewOrRefData in agreement.ClientInformationSheet.PreRenewOrRefDatas)
                {
                    ...
                    if (preRenewOrRefData.DataType == "preendorsement" && preRenewOrRefData.EndorsementProduct == "LPD")
                    {
            ...
            ClientAgreementTerm termlpd100klimitoption = GetAgreementTerm(underwritingUser, agreement, "LPD", TermLimit100k, TermExcess);
            termlpd100klimitoption.TermLimit = TermLimit100k;
            termlpd100klimitoption.Premium = TermPremium100k;
            termlpd100klimitoption.BasePremium = TermPremium100k;
            termlpd100klimitoption.Excess = TermExcess;
            termlpd100klimitoption.BrokerageRate = agreement.Brokerage;
            termlpd100klimitoption.Brokerage = TermBrokerage100k;
            termlpd100klimitoption.DateDeleted = null;
            termlpd100klimitoption.DeletedBy = null;

            //Change policy premium calculation
            if (agreement.ClientInformationSheet.IsChange && agreement.ClientInformationSheet.PreviousInformationSheet != null)
            {
                termlpd100klimitoption.Bound = true;
            }
            ...
            string retrodate = "1 October 2012";
            ...
            string auditLogDetail = "Abbott LPD UW created/modified";
