...
namespace TechCertain.WebUI.Models
{
	public class VehicleViewModel : BaseViewModel
	{
		...
		public Vehicle UpdateEntity (Vehicle vehicle)
		{
            ...
            {
                vehicle.VehicleEffectiveDate = DateTime.Parse(EffectiveDate, System.Globalization.CultureInfo.CreateSpecificCulture("en-NZ"));
            } else
            {
            ...
            {
                vehicle.VehicleCeaseDate = DateTime.Parse(CeaseDate, System.Globalization.CultureInfo.CreateSpecificCulture("en-NZ"));
            } else
            {
		...
		public static VehicleViewModel FromEntity (Vehicle vehicle)
		{
			VehicleViewModel model = new VehicleViewModel {
				...
				Notes = vehicle.Notes,
                EffectiveDate = (vehicle.VehicleEffectiveDate > DateTime.MinValue) ? vehicle.VehicleEffectiveDate.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("en-NZ")) : "",
                CeaseDate = (vehicle.VehicleCeaseDate > DateTime.MinValue) ? vehicle.VehicleCeaseDate.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("en-NZ")) : "",
