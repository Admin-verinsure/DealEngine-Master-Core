...
namespace TechCertain.Services.Impl
{
    public class HttpClientService : IHttpClientService
    {
        ...
        public HttpClientService(IUnitOfWork unitOfWork, IMapperSession<LogInfo> logInfoMapperSession)
        {
        ...
        public Task<string> Analyze(string request)
        {
            ...
            {
                var log = new LogInfo();
                log.AnalyzeXMLRSA = _httpRequestMessage.Content.ReadAsStringAsync().Result;
                _logInfoMapperSession.Add(log);
                uow.Commit();
            }
                            ...
                            <analyze xmlns = ""http://ws.csd.rsa.com"">                                             
                                <request>                                             
                                    ...
                                    <identificationData>
                                        ...
                                        <userEmailAddress>ray@techcertain.com</userEmailAddress>                                                                                                                                                                                                                                                                                                              
