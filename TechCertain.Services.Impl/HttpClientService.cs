...
namespace TechCertain.Services.Impl
{
    ...
    {
        public Task<string> Analyze(string request, string SOAPAction, string service)
        {
            var responseMessage = "";
        ...
        public Task<string> EGlobalAPI(string xmlPayload, string SOAPAction, string service)
        {
            var responseMessage = "";
