...
namespace DealEngine.Services.Interfaces
{
	public interface IEmailService
	{
        ...
        Task GetInvoicePDF(string recipent, SystemDocument documents, ClientInformationSheet clientInformationSheet, ClientAgreement clientAgreement, string recipentcc);
