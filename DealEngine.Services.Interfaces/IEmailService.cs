...
namespace DealEngine.Services.Interfaces
{
	public interface IEmailService
	{
        ...
        Task SendPremiumAdviceEmail(string recipent, List<SystemDocument> documents, ClientInformationSheet clientInformationSheet, ClientAgreement clientAgreement);
