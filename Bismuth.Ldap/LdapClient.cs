...
namespace Bismuth.Ldap
{
	public class LdapClient : Disposable
	{
        ...
        /// <summary>
        /// Sets the send and recieve timeouts for the connection.
        /// </summary>
        /// <param name="milliseconds">Timeout in milliseconds.</param>
        protected void SetConnectionTimeout(int milliseconds)
        {
            _timeout = milliseconds;
            if (currentConnection != null)
            {
                currentConnection.ReceiveTimeout = milliseconds;
                currentConnection.SendTimeout = milliseconds;
            }
        }
	}
}
